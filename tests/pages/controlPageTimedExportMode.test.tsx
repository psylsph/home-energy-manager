...
describe('<ControlPage/> — independent battery mechanisms', () => {
  ...
  it('shows Eco, Timed Charge, Timed Export and Timed Discharge together', async () => {
  ...
  it('saves Timed Discharge as a separate pause-window mechanism', async () => {
    useInverterStore.setState({ snapshot: makeSnapshot({ battery_pause_mode: 0 }), developerMode: false });
    render(<ControlPage />);
