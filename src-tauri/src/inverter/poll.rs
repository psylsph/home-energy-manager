...
// Automation state-machine types (AutoWinter*, LoadLimiter*) live in
// [`state_machines`]. They are re-exported below so existing
// `crate::inverter::poll::*` references keep working.
